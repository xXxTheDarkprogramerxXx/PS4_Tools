...
{
    public partial class PS4_Medial_Player : Form
    {
        System.Media.SoundPlayer player;
        bool Playing = false;
        public PS4_Medial_Player()
        {
            InitializeComponent();
        }
        public PS4_Medial_Player(byte[] at9)
        {
            InitializeComponent();
            try
            {
                var bytes = PS4_Tools.Media.Atrac9.LoadAt9(at9);
        ...
        private void PS4_Medial_Player_Load(object sender, EventArgs e)
        {

        }

        private void PS4_Medial_Player_FormClosing(object sender, FormClosingEventArgs e)
        {
            if(Playing == true)
            {
                player.Stop();
