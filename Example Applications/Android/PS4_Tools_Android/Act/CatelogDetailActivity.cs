...
//    public class CatelogDetailActivity : AppCompatActivity
//    {
...
//            //here we get the product information



//            SpecialService.ProductResult result = Constants._service.Retrieve(_IDX, true);
//            if (result.Successful == true)
//            {

//                SpecialService.Product_Object catelogobject = result.ResultList;


//                string cheeseName = Intent.GetStringExtra(catelogobject.ProductName);
//                imgurl = catelogobject.ProductImage;
...
//            WMSScanner.BoolResult  result = Constants._service.RetrieveList(loadint, true, _IDX, true, SubIDX, true, DistanceFilter, true);
//            if (result.Successful == true)
//            {


//                adapter = new SimpleStringRecyclerViewAdapter(recyclerView,result.ResultList);
