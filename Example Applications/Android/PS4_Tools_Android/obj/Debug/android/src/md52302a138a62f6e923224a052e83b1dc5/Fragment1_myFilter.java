...
public class Fragment1_myFilter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DesignLibrary_Tutorial.Fragments.Fragment1+myFilter, com.jem.onspecial, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", Fragment1_myFilter.class, __md_methods);
	}


	public Fragment1_myFilter () throws java.lang.Throwable
	{
		super ();
		if (getClass () == Fragment1_myFilter.class)
			mono.android.TypeManager.Activate ("DesignLibrary_Tutorial.Fragments.Fragment1+myFilter, com.jem.onspecial, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}

	public Fragment1_myFilter (android.support.v7.widget.RecyclerView.Adapter p0) throws java.lang.Throwable
	{
		super ();
		if (getClass () == Fragment1_myFilter.class)
			mono.android.TypeManager.Activate ("DesignLibrary_Tutorial.Fragments.Fragment1+myFilter, com.jem.onspecial, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Support.V7.Widget.RecyclerView+Adapter, Xamarin.Android.Support.v7.RecyclerView, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", this, new java.lang.Object[] { p0 });
	}
